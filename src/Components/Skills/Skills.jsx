      ...
      <div className="max-w-screen-2xl px-6 w-full pt-4 pb-12 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:grid-cols-6 items-center justify-center py-10">
          {skills.map((skill) => (
            <div
              key={skill.id}
              className="flex flex-col items-center justify-center gap-4 bg-[#11152C] rounded-2xl overflow-hidden relative border-2 border-[#45428d] hover:border-[#7f48e6] hover:shadow-[0_0_30px_rgba(127,72,230,0.2)] duration-300 hover:scale-[1.15] transition-all p-4" data-aos="zoom-in-up" data-aos-duration="1500"
